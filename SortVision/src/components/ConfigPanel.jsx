    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-slate-900 p-4 rounded border border-slate-800 relative overflow-hidden group">
          ...
          <div className="absolute bottom-0 left-0 h-0.5 w-0 group-hover:w-full bg-gradient-to-r from-emerald-500/50 via-purple-500/50 to-blue-500/50 rounded transition-all duration-700"></div>
        ...
        <div className="bg-slate-900 p-4 rounded border border-slate-800 relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <div className="mb-3 bg-slate-800/90 p-2 rounded border border-slate-700">
            ...
            <div className="mb-3">
              ...
              <div className="bg-slate-800/90 p-2 rounded border border-slate-700 flex items-center">
        ...
        <div className="bg-slate-900 p-4 rounded border border-slate-800 relative overflow-hidden group">
          ...
          {/* Add animated gradient line */}
          <div className="absolute bottom-0 left-0 h-0.5 w-0 group-hover:w-full bg-gradient-to-r from-green-500/50 via-yellow-500/50 to-red-500/50 rounded transition-all duration-700"></div>
