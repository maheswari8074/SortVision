    ...
    <CardHeader className="border-b border-slate-800 bg-slate-900">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="font-mono text-xs text-emerald-400 hover:text-emerald-300 border border-slate-700 px-3 py-1 rounded-md hover:bg-slate-800 transition-all duration-200"
        >
          Restart Tutorial
        </button>
      </div>
